...
const config: Config = {
  ...
  url: 'https://nazari2079.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/react-state-timeline/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'nazari2079', // Usually your GitHub org/user name.
  projectName: rootPackage.name, // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: rootPackage.repository.url,
          label: 'GitHub',
          position: 'right',
        },
      ],
